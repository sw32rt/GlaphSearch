...
void BreadthFirstSearch::init(int StartVertexIndex, int SearchVertexIndex)
{
...
int BreadthFirstSearch::GetNextSearchVertex(int CurrentVertex)
{
    int nextIndex = 0;
    ...
    nextIndex = NextSearchVertexStack.front();
    NextSearchVertexStack.pop_front();
    // 次の頂点を計算する
    return nextIndex;
}

bool BreadthFirstSearch::SearchNext(void)
{
    bool Finish = false;
